...
export default function Projects() {
  ...
  const projects = [
    {
      ...
      description: 'An intelligent learning and interview preparation platform designed to help students practice coding and theory with automated evaluation.',
      tech: ['MERN Stack', 'Gemini API', 'JWT Auth', 'REST APIs', 'Node.js', 'Express.js', 'MongoDB'],
      ...
      github: 'https://github.com/vishwas8671/EduAI-AI-Powered-Learning-Interview-Preparation-Assistant',
      demo: 'https://ai-powered-learning-interview-assis.vercel.app/',
    },
    {
      title: 'FinTrack — Financial Transaction System',
      description: 'A transaction management platform enabling users to track expenditures, analyze budgets, and structure finance details with secure access.',
      tech: ['MERN Stack', 'MongoDB Aggregation', 'RBAC Security', 'REST APIs', 'Express.js', 'React.js'],
      ...
      github: 'https://github.com/vishwas8671/FinTrack-Financial-Transaction-Management-System',
  ...
  return (
    <section id="projects" className="py-20 px-4 md:px-8 bg-slate-950/60 relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-500">Projects</span>
          </h2>
          ...
          <p className="text-gray-400 text-sm md:text-base mt-4 max-w-lg mx-auto">
            A showcasing of production-ready web applications, featuring AI APIs, database aggregation, and backend security.
          </p>
        </div>
                ...
                <div className="h-48 sm:h-56 relative overflow-hidden group">
                  ...
                  <div className="absolute top-4 left-4 z-20 flex flex-wrap gap-1.5">
                    {project.categories.map((cat) => (
                      <span key={cat} className="text-[10px] uppercase tracking-wider font-semibold font-mono bg-cyan-950/80 border border-cyan-800/50 text-cyan-400 px-2 py-0.5 rounded">
                        {cat}
                      </span>
                    ))}
                  </div>
                ...
                <div className="p-6 space-y-5 flex-1 flex flex-col justify-between">
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-xs sm:text-sm text-gray-500">
                      {project.features.map((feat, fIdx) => (
                        <li key={fIdx} className="flex items-start space-x-2 text-left">
                  ...
                  <div className="space-y-4 pt-4 border-t border-slate-900">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {project.tech.map((t) => (
                        <span key={t} className="text-[11px] font-mono font-medium text-indigo-300 bg-indigo-950/20 border border-indigo-900/30 px-2.5 py-0.5 rounded-full">
                          {t}
                        </span>
                      ))}
                    </div>
